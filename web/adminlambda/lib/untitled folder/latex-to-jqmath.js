...
var CLEAN_LATEX_LITERAL_REPLACEMENTS = [
    ["\\Rightarrow &", "⇒"],
    ["&\\Rightarrow", "⇒"],
    ["&\\times", "×"],
    ["\\,", "\\;"],
...
var CLEAN_LATEX_COMMAND_REPLACEMENTS = [
    ["Longrightarrow", "⇒"],
    ["xrightarrow", "{───────▶}"],
    ["Rightarrow", "⇒"],
    ["rightarrow", "⟶"],
...
function cleanlatex(input) {
    ...
    st1 = applyLatexReplacements(st1, CLEAN_LATEX_LITERAL_REPLACEMENTS, false);
    st1 = applyLatexReplacements(st1, CLEAN_LATEX_COMMAND_REPLACEMENTS, true);
...
function makeTextCharBeautiful(st1) {
    st1 = applyLatexReplacements(st1, [["in", "∈"]], true);
